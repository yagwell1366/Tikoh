...
class IsolationCog(commands.Cog):
    ...
    def __init__(self, bot: commands.Bot, owner_id: int | None = None) -> None:
        self.bot = bot
    ...
    async def on_member_join(self, member: discord.Member):
        ...
        try:
            ...
            # Staff log
            staff_ch = member.guild.get_channel(STAFF_LOG_CHANNEL_ID) or self.bot.get_channel(STAFF_LOG_CHANNEL_ID)
    ...
    async def isolate(self, ctx: commands.Context, target: discord.Member | None = None):
        ...
        try:
            ...
            pass
        staff_ch = guild.get_channel(STAFF_LOG_CHANNEL_ID) or self.bot.get_channel(STAFF_LOG_CHANNEL_ID)
        if isinstance(staff_ch, (discord.TextChannel, discord.Thread)):
